document.addEventListener('DOMContentLoaded', function () {
    ...
    if (graffitiButton) {
        ...
        graffitiButton.addEventListener('click', function () {
            ...
            // Prüfen, ob ein bestehendes Canvas vorhanden ist
            ...
            if (!canvas) {
                ...
                canvas.style.display = 'none';  // Startausblenden
            }
            ...
            ctx.font = fontSize + 'px BlackDestroyPersonal, Arial';  // Deine Graffiti-Schrift
